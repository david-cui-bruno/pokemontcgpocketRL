...
def basic_game_state(basic_pokemon, evolution_pokemon):
    ...
    return GameState(player=player_state, phase=GamePhase.MAIN)
...
class TestActionValidation:
    ...
    def test_can_play_basic_pokemon(self, basic_game_state):
        ...
        basic_game_state.player.hand.append(basic_pokemon)
        
        assert ActionValidator.can_play_pokemon(basic_game_state, basic_pokemon)
    ...
    def test_can_retreat(self, basic_game_state):
        ...
        basic_game_state.player.energy_zone = EnergyType.COLORLESS
        
        assert ActionValidator.can_retreat(basic_game_state)
    ...
    def test_can_attack(self, basic_game_state):
        ...
        basic_game_state.player.active_pokemon.attached_energies = [EnergyType.COLORLESS]
        
        assert ActionValidator.can_attack(basic_game_state, 0)
